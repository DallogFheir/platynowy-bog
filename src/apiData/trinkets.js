export const trinkets = {
  ...
  127: {
    ...
    unlock: {
      method: "other",
      other: "have 2 effects of homing tears simultaneously",
    },
  },
  105: {
    id: 105,
  ...
  50: {
    ...
    setDrop: ["TNT", "Special Shopkeeper"],
  },
  24: {
    id: 24,
    name: "Butt Penny",
  ...
  147: {
    ...
    unlock: {
      method: "other",
      other: "donate to Battery Bums until they pay out with an item 5 times",
    },
  },
  130: {
    id: 130,
  ...
  34: {
    ...
    setDrop: ["Blood Donation Machine", "starting trinket"],
  },
  89: {
    id: 89,
    name: "Child Leash",
  ...
  52: {
    ...
    unlock: {
      method: "other",
      other: "play Shell Game/Hell Game 100 times",
    },
    setDrop: ["Golden Poop"],
  },
  92: {
    ...
    unlock: {
      method: "other",
      other: "get a 5-win streak in Daily Challenges",
    },
  },
  67: {
    id: 67,
  ...
  124: {
    ...
    unlock: {
      method: "other",
      other: "blow up 50 doors and Secret Room walls",
    },
  },
  109: {
    id: 109,
  ...
  125: {
    ...
    unlock: {
      method: "other",
      other: "collect The Battery, 9 Volt and Car Battery",
    },
  },
  69: {
    id: 69,
  ...
  123: {
    ...
    unlock: {
      method: "other",
      other: "pick up both Key Pieces in a single run",
    },
  },
  128: {
    id: 128,
  ...
  141: {
    ...
    unlock: {
      method: "other",
      other: "blow up The Siren's skull     ",
    },
    setDrop: ["thematic boss drop"],
  },
  180: {
  ...
  120: {
    ...
    unlock: {
      method: "other",
      other: "recharge active item using Lil' Batteries 20 times",
    },
  },
  168: {
    id: 168,
  ...
  15: {
    id: 15,
    name: "Lucky Rock",
    quote: "There's something inside it",
    unlock: {
      method: "other",
      other: "destroying 100 rocks",
    },
  },
  160: {
    id: 160,
  ...
  42: {
    ...
    unlock: {
      method: "other",
      other: "destroying 20 Shopkeepers",
    },
  },
  55: {
    id: 55,
  ...
  143: {
    ...
    unlock: {
      method: "other",
      other: "blowing up 10 Battery Bums",
    },
  },
  96: {
    id: 96,
  ...
  145: {
    ...
    setDrop: ["after clearing 3 consecutive floors without taking damage"],
  },
  2: {
    id: 2,
    name: "Petrified Poop",
  ...
  126: {
    ...
    unlock: {
      method: "other",
      other: "having 20 Blue Flies at the same time",
    },
  },
  36: {
    id: 36,
  ...
  62: {
    id: 62,
    name: "Shiny Rock",
    quote: "It shines for its brothers",
  },
  133: {
    id: 133,
    name: "Short Fuse",
  ...
  83: {
    ...
    unlock: {
      other: "donate 666 coins to Greed Donation Machine",
      method: "other",
    },
    setDrop: ["starting trinket"],
  },
  ...
  1: {
    ...
    quote: "Gulp!",
    setDrop: ["urn", "Special Shopkeeper"],
    unlock: {
      method: "challenge",
      challengeName: "Slow Roll",
      challengeNumber: 15,
    },
  },
  65: {
  ...
  152: {
    ...
    unlock: {
      method: "other",
      other:
        'collecting 3 "star" items in one run (Card Reading, Crystal Ball, Deck of Cards, Echo Chamber, Magic 8 Ball, Star of Bethlehem, Tarot Cloth, Zodiac signs, Planetarium items)',
    },
  },
  177: {
    id: 177,
  ...
  108: {
    id: 108,
    name: "Walnut",
    quote: "That's a hard nut to crack!",
  },
  72: {
    id: 72,
    name: "Watch Battery",
  ...
  122: {
    ...
    unlock: {
      method: "other",
      other: "complete 2 Victory Laps and start a 3rd",
    },
  },
  94: {
    id: 94,
